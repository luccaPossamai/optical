...
public class COPonderIndex {
    ...
    public static void initiate() {
        ...
        HELPER.forComponents(COBlocks.ABSORPTION_POLARIZING_FILTER, COBlocks.OPTICAL_SOURCE).addStoryBoard("opticals/polarization_filter", COPonderScenes::polarization, COPonderTags.OPTICALS);
        HELPER.forComponents(COBlocks.POLARIZING_BEAM_SPLITTER_BLOCK, COBlocks.OPTICAL_SOURCE).addStoryBoard("opticals/polarization_cube", COPonderScenes::polarizationCube, COPonderTags.OPTICALS);
